...
# ESTE ARCHIVO SOLO ES PARA LEER/PRINTEAR LA INFORMACIÓN    
from pathlib import Path

def read_config(path):
    """
    Lee un config.dat muy sencillo:
      nombre = valor;
...
def write_solution(solution_path, S, covered, cost):
    """
    Escribe una solución en formato .dat (estilo OPL):
       x = [...];
       y = [...];
       total_cost = ...;
    """
